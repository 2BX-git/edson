...
$complemento = $bairro = $cidade = $uf = $cep = $pais = $ddd = $telefone1 = '';
$telefone2 = $telefone3 = $whatsapp = $email = $cargo = $vinculo = $classificacao = '';
$status = $tipo_interacao = $data_interacao = $observacoes = $atividade = $natureza_juridica = '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_contact'])) {
    ...
    if ($id > 0) {
        $sql = "UPDATE tabela_principal SET 
            ...
            tipo_interacao=" . ($tipo_interacao ? "'$tipo_interacao'" : "NULL") . ",
